...
def main():
    ...
    input_filepath_users = "/opt/airflow/data/users.csv"
    input_filepath_caract = "/opt/airflow/data/caract.csv"
    input_filepath_places = "/opt/airflow/data/places.csv"
    input_filepath_veh = "/opt/airflow/data/veh.csv"
    output_folderpath = "/opt/airflow/data/preprocessed"

    # Appelez la fonction build_features
    build_features(input_filepath_users, input_filepath_caract, input_filepath_places, input_filepath_veh, output_folderpath)
